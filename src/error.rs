//! This module defines the `AppError` struct, which define common Error for the `gedeair_backend` application.

/// Custom error type for the `gedeair_backend` application.
///
