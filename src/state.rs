//! This module defines the `AppState` struct, which holds shared state for the `gedeair_backend` application.
...
///
/// This struct holds the state shared across the entire `gedeair_backend` application.
#[derive(Clone)]
pub struct AppState {
